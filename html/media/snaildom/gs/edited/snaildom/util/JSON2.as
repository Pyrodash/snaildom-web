class JSON2
{
            ...
            case "object":
            {
                if (arg)
                {
                    if (arg instanceof Array)
                    {
                        ...
                        {
                            _loc4 = JSON2.stringify(arg[_loc2]);
                            if (_loc1)
                            {
                                _loc1 = _loc1 + ",";
                            } // end if
                    ...
                    else if (typeof(arg.toString) != "undefined")
                    {
                        for (var _loc2 in arg)
                        {
                            ...
                            {
                                _loc4 = JSON2.stringify(_loc4);
                                if (_loc1)
                                {
                                    _loc1 = _loc1 + ",";
                                } // end if
                                _loc1 = _loc1 + (JSON2.stringify(_loc2) + ":" + _loc4);
                            } // end if
                        } // end of for...in
                        return ("{" + _loc1 + "}");
                    } // end if
    ...
    function key()
    {
        ...
        if (_loc4 <= _loc3 && _loc4 > -1 || _loc5 <= _loc3 && _loc5 > -1)
        {
            _loc2 = this.str();
            this.white();
            if (ch == ":")
