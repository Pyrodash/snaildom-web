class util.JSON
{
   ...
   {
      if(util.JSON.inst == null)
      {
         util.JSON.inst = new util.JSON();
      }
      return util.JSON.inst;
   }
      ...
      switch(typeof arg)
      {
         case "object":
            if(arg)
            {
               ...
               {
                  _loc5_ = 0;
                  while(_loc5_ < arg.length)
                  {
                     _loc3_ = util.JSON.stringify(arg[_loc5_]);
                     if(_loc1_)
                     {
                        _loc1_ = _loc1_ + ",";
                     }
               ...
               {
                  for(var _loc5_ in arg)
                  {
                     _loc3_ = arg[_loc5_];
                     if(typeof _loc3_ != "undefined" && typeof _loc3_ != "function")
                     {
                        _loc3_ = util.JSON.stringify(_loc3_);
                        if(_loc1_)
                        {
                           _loc1_ = _loc1_ + ",";
                        }
                        _loc1_ = _loc1_ + (util.JSON.stringify(_loc5_) + ":" + _loc3_);
                     }
                  }
                  return "{" + _loc1_ + "}";
               }
               ...
               else
               {
                  switch(_loc2_)
                  {
                     ...
                     default:
                        ...
                        _loc1_ = _loc1_ + ("\\u00" + Math.floor(_loc2_ / 16).toString(16) + (_loc2_ % 16).toString(16));
                  }
               }
               _loc5_ = _loc5_ + 1;
            }
   ...
   static function parse(text)
   {
      ...
      {
         var _loc1_ = util.JSON.getInstance();
         _loc1_.at = 0;
         _loc1_.ch = " ";
         _loc1_.text = text;
         return _loc1_.value();
            ...
            if(this.ch == "\\")
            {
               switch(this.next())
               {
                  ...
                  case "u":
                     ...
                     _loc2_ = _loc2_ + String.fromCharCode(_loc5_);
                     break;
                  default:
   ...
   function key()
   {
      ...
      if(_loc4_ <= _loc5_ && _loc4_ > -1 || _loc3_ <= _loc5_ && _loc3_ > -1)
      {
         _loc2_ = this.str();
         this.white();
         if(this.ch == ":")
